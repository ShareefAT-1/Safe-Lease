...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative max-w-5xl mx-auto text-center backdrop-blur-md bg-black/30 p-8 md:p-16 lg:p-20 rounded-3xl shadow-2xl z-20" 
      >
        <motion.div
        ...
        >
          <motion.h1
            ...
            className="text-5xl md:text-6xl font-extrabold text-blue-200 mb-6" 
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg text-gray-500 leading-relaxed mt-10"
          >
